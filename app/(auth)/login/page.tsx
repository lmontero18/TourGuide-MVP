...
function LoginForm() {
  ...
  return (
    <div>
      ...
      <button
        type="button"
        className="mt-4 w-full h-11 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-navy-900 transition-all hover:bg-slate-50 hover:border-slate-300 active:scale-[0.98] flex items-center justify-center gap-2.5"
      >
